...
public class SmartCard_Driver
{
   public static void main(String[] args) 
   {
      ...
      //System.out.println(buddy.cost(center));
      //System.out.println("getIsBoarded() "+ buddy.getIsBoarded());
      //System.out.println("getBoardedAt() "+ buddy.getBoardedAt());
      //System.out.println();
      ...
      */
      ...
      mc.board(center);            		// See the output below
      mc.exit(center);					   // See the output below
      System.out.println();
      System.out.println(mc.getBoardedAt());
      // SmartCard asdf = new SmartCard(10.00);
      // asdf.addMoney(5.00);
      // System.out.println(asdf.getFormattedBalance());
